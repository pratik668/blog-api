...
import com.blogApp.demo.Payloads.PostDto;
import com.blogApp.demo.Payloads.PostResponse;
import com.blogApp.demo.entities.Category;
import com.blogApp.demo.entities.Post;
...
import com.blogApp.demo.repository.PostRepo;
...
public class PostServiceImpl implements PostService {
	...
	public PostDto updatePost(PostDto postDto, Integer postId) {
		...
		Category category = this.categoryRepo.findById(postDto.getCategory().getId()).get();
